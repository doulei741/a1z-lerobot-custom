...
export function Recording() {
  ...
  const start = useMutation({ mutationFn: () => api.startRecord(requestBody()), onSuccess: (result) => setActive(result.task_id, result.task_type) })
